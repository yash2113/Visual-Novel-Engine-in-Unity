...
namespace CHARACTERS
{
    public class CharacterSpriteLayer
    {
        ...
        private float transitionSpeedMultiplayer = 1;
        ...
        private IEnumerator TransitioningSprite(Sprite sprite, float speedMultiplayer)
        {
            transitionSpeedMultiplayer = speedMultiplayer;
        ...
        private IEnumerator RunAlphaLeveling()
        {
            ...
            {
                float speed = DEFAULT_TRANSITION_SPEED * transitionSpeedMultiplayer * Time.deltaTime;
        ...
        private IEnumerator FaceDirection(bool faceLeft, float speedMultiplier, bool immediate)
        {
            ...
            if(!immediate)
            {
                ...
                transitionSpeedMultiplayer = speedMultiplier;
