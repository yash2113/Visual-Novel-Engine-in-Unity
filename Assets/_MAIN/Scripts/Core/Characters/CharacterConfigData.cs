    ...
    public class CharacterConfigData
    {
        ...
        public static CharacterConfigData Default
        {
            get
            {
                ...
                result.dialogueFontScale = DialogueSystem.instance.config.defaultDialogueFontSize;
                result.nameFontScale = DialogueSystem.instance.config.defaultNameFontSize;
