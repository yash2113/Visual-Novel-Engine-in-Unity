...
namespace CHARACTERS
{
    public class CharacterManager : MonoBehaviour
    {
        ...
        public Character CreateCharacter(string characterName, bool revealAfterCreation = false)
        {
            if (characters.ContainsKey(characterName.ToLower()))
            {
                Debug.LogWarning($"A Character called '{characterName}' already exists. Do not create the character.");
                return null;
            }
        ...
        public void SortCharacters(string[] characterNames)
        {
            ...
            sortedCharacters = characterNames.Select(name => GetCharacter(name))
