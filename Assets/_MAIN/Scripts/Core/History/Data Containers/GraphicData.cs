...
namespace History
{
    ...
    public class GraphicData
    {
        ...
        {
            List<GraphicData> grpahicPanels = new List<GraphicData>();
            ...
            foreach(var panel in GraphicPanelManager.instance.allPanels)
            {
                ...
                grpahicPanels.Add(data);
            }

            return grpahicPanels;
        }
                    ...
                    if (layer.currentGraphic == null || layer.currentGraphic.graphicName != layerData.graphicName)
                    {
                        ...
                        else
                        {
                            ...
                            if (clip != null)
                                ...
                                Debug.LogWarning($"History State: Could not load video from the path '{layerData.graphicPath}'");
                        }
                    }
                }
