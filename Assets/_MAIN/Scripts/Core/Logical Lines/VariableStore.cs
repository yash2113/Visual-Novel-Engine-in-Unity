...
public class VariableStore
{
    ...
    private static Database defaultDataase => databases[DEFAULT_DATABASE_NAME];
    ...
    private static (string[], Database, string) ExtractInfo(string name)
    {
        ...
        Database db = parts.Length > 1 ? GetDatabase(parts[0]) : defaultDataase;
